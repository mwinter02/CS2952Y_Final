...
1. Load a static mesh (e.g., "bunny.obj").
...
1. Load a skeletal mesh (e.g., "walking.fbx").
...
3. Press the "Decompose" button.
4. View your decomposed parts, use the render options tab to toggle visibility and draw modes.
5. You will find the output file named "Colliders/walking_collider.obj" in the same directory as the input mesh. It will be rigged to the same skeleton as the input mesh.
